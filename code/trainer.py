...
class Trainer(object):
    ...
    def train(self, resume=False, checkpoint_path=None):
        ...
        for epoch in range(start_epoch, self.epochs):
            ...
            print(f"Epoch {self.current_epoch} | AUROC: {auroc:.4f} | AUPRC: {auprc:.4f} | Val Loss: {val_loss:.4f}")
            ...
            if auroc > self.best_auroc:
                ...
                print(f"⭐ Best model saved at epoch {self.current_epoch} (AUROC improved)")
            else:
